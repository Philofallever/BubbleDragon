...
b3.ActionCallFun        = require("cocos.framework.BehaviorTree3.Actions.ActionCallFun")
...
b3.DecoratorSuccess     = require("cocos.framework.BehaviorTree3.Decorators.DecoratorSuccess")

--Condition
b3.ConditionCallFun     = require("cocos.framework.BehaviorTree3.Conditions.ConditionCallFun")
